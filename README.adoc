...
Developed using the SGDK (Sega Genesis Development Kit) for a college subject called *Legacy Platform Development* — the first Mega Drive development course in Brazil, taught by Marcos Silvano Almeida — this project showcases the capabilities of homebrew development on classic 16-bit hardware.
